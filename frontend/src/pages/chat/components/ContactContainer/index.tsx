    ...
    <div className="relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] bg-[#1b1c24] border-r-2 border-[#2f303b] w-full ">
      ...
      <div className="my-5">
        <div className="flex items-center justify-between pr-10">
          ...
          <div className={`bg-black/60 backdrop-filter backdrop-blur-sm transition duration-200 cursor-pointer left-0 absolute top-0 bottom-0 right-0 ${openNewContactModel ? "scale-100 opacity-1" : "scale-0 opacity-0"}`}>
            ...
            <div className={`px-4`}>
              <span className="block text-white font-bold text-[14px] mt-20 mb-10 text-center">Search / Select a contact</span>
      ...
      <div className="absolute bottom-0 h-16 flex items-center justify-between px-10 w-full bg-[#2a2b33]">
        ...
        <div className="flex gap-5">
          <div>
            <FiEdit2 className="cursor-pointer text-lg hover" onClick={() => navigate("/profile")} />
            <div className="bg-[#1c1b1e] border-none text-white hidden">Edit profile</div>
          </div>

          <div>
            <IoLogOut onClick={handleLogout} className="cursor-pointer text-lg" />
          </div>
        </div>
      </div>
